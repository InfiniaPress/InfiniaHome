...
/**
 * This class defines the structure of the 'infiniaconfiguration' table.
 *
 *
 *
...
class ConfigurationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'InfiniaHome.DB.Map.ConfigurationTableMap';
     ...
     */
    const TABLE_NAME = 'infiniaconfiguration';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\InfiniaHome\\DB\\Configuration';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'InfiniaHome.DB.Configuration';
     ...
     */
    const COL_KEY = 'infiniaconfiguration.key';

    /**
     * the column name for the value field
     */
    const COL_VALUE = 'infiniaconfiguration.value';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ConfigurationTableMap::COL_KEY, ConfigurationTableMap::COL_VALUE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ConfigurationTableMap::COL_KEY => 0, ConfigurationTableMap::COL_VALUE => 1, ),
    ...
    {
        // attributes
        $this->setName('infiniaconfiguration');
        $this->setPhpName('Configuration');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\InfiniaHome\\DB\\Configuration');
        $this->setPackage('InfiniaHome.DB');
        $this->setUseIdGenerator(false);
        // columns
        $this->addPrimaryKey('key', 'Key', 'LONGVARCHAR', true, null, null);
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ConfigurationTableMap::COL_KEY);
            $criteria->addSelectColumn(ConfigurationTableMap::COL_VALUE);
        } else {
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(ConfigurationTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(ConfigurationTableMap::TABLE_NAME)) {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \InfiniaHome\DB\Configuration) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(ConfigurationTableMap::DATABASE_NAME);
            $criteria->add(ConfigurationTableMap::COL_KEY, (array) $values, Criteria::IN);
        }
...
//
ConfigurationTableMap::buildTableMap();
